...
export default function Home() {
  ...
  const projects = [
    ...
    { 
      ...
      description: "My first portfolio website. Helped me with the basics. Made with HTML, CSS, and JS. Deployed on Netlify. Features About, Experience, Projects, and Contact Sections. Responsive Website Design and has Dark mode button. ", 
      image: "/project5.png", 
